...
public class DailyBill implements BillStratergy {

    private final VehicleInventoryManager vehicleInventoryManager;
    private final ReservationRepository reservationRepository;


    public DailyBill(VehicleInventoryManager vehicleInventoryManager, ReservationRepository reservationRepository) {
